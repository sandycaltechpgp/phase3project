...
<form action="adminsearchpurchase" method="post">
    Purchase Start Date :
    <input type="date" name="searchpname"/>
    Purchase End Date:
    <input type="date" name="searchcname"/>
    <input type="submit" value="ok"/>
</form>


<form action="adminsearchpurchasecat" method="post">
    Purchase Category :
    <input type="date" name="searchpname"/>
    <input type="submit" value="ok"/>
</form>
...
<table border=1 cellspacing=2 cellpadding=4>
    ...
    <c:forEach items="${list}" var="item">
        <tr>
            ...
            <td>
                <a href="admindeleteorder?id=${item.ID}">Delete</a>
            </td>
        </tr>
    </c:forEach>
